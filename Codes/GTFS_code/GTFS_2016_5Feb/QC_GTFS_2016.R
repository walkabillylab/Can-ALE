...
setwd("V:/CanALE/Data/GTFS/GTFS_2016/QC")
...
is_valid_date <- function(date) {
  ...
  holidays <- as.Date(c(
    "2016-03-25", # Good Friday (commonly observed in QC)
    "2016-03-28", # Easter Monday (not strictly statutory, optional)
    "2016-05-23", # National Patriotes Day (Fête des Patriotes)
    "2016-06-24", # Saint-Jean-Baptiste
...
base_url <- "https://transitfeeds.com/p/societe-de-transport-de-laval/38"
