...
setwd("V:/CanALE/Data/GTFS/GTFS_2021/MB")
...
is_valid_date <- function(date) {
  ...
  holidays <- as.Date(c(
    "2021-02-15", # Louis Riel Day
    "2021-04-02", # Good Friday
    "2021-04-05", # Easter Monday (not statutory, but excluded)
    "2021-05-24", # Victoria Day
    "2021-07-01", # Canada Day
    "2021-08-02", # Civic Holiday (Terry Fox Day, not statutory)
