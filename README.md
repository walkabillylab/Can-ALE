...
| ------- | ------------- |
| 2006 Can-ALE Dataset | [CanALE_2006.csv](https://github.com/walkabillylab/Can-ALE/blob/main/Results/Can-ALE/CanALE_2006.csv) |
| 2011 Can-ALE Dataset | [CanALE_2011.csv](https://github.com/walkabillylab/Can-ALE/blob/main/Results/Can-ALE/CanALE_2011.csv) |
| 2016 Can-ALE Dataset | [CanALE_2016.csv](https://github.com/walkabillylab/Can-ALE/blob/main/Results/Can-ALE/CanALE_2016.csv) |
| 2021 Can-ALE Dataset | [CanALE_2021.csv](https://github.com/walkabillylab/Can-ALE/blob/main/Results/Can-ALE/CanALE_2021.csv) |
...
To ensure the index accurately reflects the environments that people actually live in, all measures were computed for the area within a 1-kilometer circular (Euclidean) buffer centered on the [**population-weighted centroid**](https://github.com/walkabillylab/Can-ALE/tree/main/Data/PopWeighted_Centroid) of each Dissemination Area, rather than a simple geometric centroid. This weighted centroid represents the population's "center of mass" and was computed by taking the weighted average of the centroids of its constituent Dissemination Blocks (DBs), using the population of each block as its weight. In cases where a Dissemination Area had zero population, the geometric centroid was used instead to ensure complete coverage and prevent any area from being omitted. Finally, the Can-ALE measures were estimated within each buffer using a precise areal interpolation method at the Dissemination Area (DA) level.
...
* [**View the Code**](https://github.com/walkabillylab/Can-ALE/tree/main/Codes/Final_Measures_Codes/DwellingPopulationDensity)
* [**View the Results**](https://github.com/walkabillylab/Can-ALE/tree/main/Results/DwellingPopulation)
...
* [**View the Code**](https://github.com/walkabillylab/Can-ALE/tree/main/Codes/Final_Measures_Codes/Transit)
* [**View the Results**](https://github.com/walkabillylab/Can-ALE/tree/main/Results/Transit)
...
* [**View the Code**](https://github.com/walkabillylab/Can-ALE/tree/main/Codes/Final_Measures_Codes/IntersectionDensity)
* [**View the Results**](https://github.com/walkabillylab/Can-ALE/tree/main/Results/IntersectionDensity)
...
* [**View the Code**](https://github.com/walkabillylab/Can-ALE/tree/main/Codes/Final_Measures_Codes/POI)
* [**View the Results**](https://github.com/walkabillylab/Can-ALE/tree/main/Results/POI)
...
<div align="center">
  <table>
    <tr>
      <td><img src="https://raw.githubusercontent.com/walkabillylab/Can-ALE/main/Results/ALE-Class-Map/montreal_ALE_2021.jpg" alt="Can-ALE Map of Montreal" width="250"></td>
      <td><img src="https://raw.githubusercontent.com/walkabillylab/Can-ALE/main/Results/ALE-Class-Map/hamilton_ALE_2021.jpg" alt="Can-ALE Map of Hamilton" width="250"></td>
    </tr>
    <tr>
      <td><img src="https://raw.githubusercontent.com/walkabillylab/Can-ALE/main/Results/ALE-Class-Map/calgary_ALE_2021.jpg" alt="Can-ALE Map of Calgary" width="250"></td>
      <td><img src="https://raw.githubusercontent.com/walkabillylab/Can-ALE/main/Results/ALE-Class-Map/saskatoon_ALE_2021.jpg" alt="Can-ALE Map of Saskatoon" width="250"></td>
    </tr>
  </table>
</div>
